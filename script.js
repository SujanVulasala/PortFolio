...
love_btns.forEach(love_btn => {
	love_btn.addEventListener('mousedown', (e) => {
		...
		love_btn.querySelector('.text').innerHTML = '<span class="grey-text">Sent to:</span> SUJAN VULASALA';
		love_btn.querySelector('.icon-container').innerHTML = '<i class="fas fa-heart"></i>';
		love_btn.querySelector('.icon-container').style.color = '#E7273F';
		love_btn.querySelector('.icon-container').style.fontSize = '30px';
		love_btn.querySelector('.icon-container').style.transition = 'all 0.5s ease-in-out';
		love_btn.querySelector('.icon-container').style.transform = 'scale(1.5)';
		love_btn.querySelector('.icon-container').style.transition = 'all 0.5s ease-in-out';
		love_btn.querySelector('.icon-container').style.transform = 'scale(1)';
		love_btn.querySelector('.icon-container').style.transition = 'all 0.5s ease-in-out';
		love_btn.querySelector('.icon-container').style.transform = 'scale(1.5)';
		love_btn.querySelector('.icon-container').style.transition = 'all 0.5s ease-in-out';
		love_btn.querySelector('.icon-container').style.transform = 'scale(1)';
...
const prog = "I AM SUJAN VULASALA...";
let idx = 1;
